...
FOOTER = '''<section class="contact-video">
  <video class="contact-video-el" data-bg autoplay muted loop playsinline poster="images/contact-poster.jpg">
    <source src="videos/contacto.mp4" type="video/mp4">
  </video>
  <div class="wrap">
    <h2>Contáctanos</h2>
    <ul class="c-list">
      <li><span class="c-icon">📍</span><a href="https://maps.app.goo.gl/6qmCh1wCLA6KnDSu8" target="_blank" rel="noopener">Parque Real #8124, Col. Los Parques, Ciudad Juárez, 32440</a></li>
      <li><span class="c-icon">✉</span><a href="mailto:arkik.desarrollos@gmail.com">grupo.arkik@gmail.com</a></li>
      <li><span class="c-icon">☎</span><a href="tel:+526561095490">+52 656 109 5490</a></li>
    </ul>
...
<footer>
  <div class="wrap footer-bottom">
    <span>© 2020–2026 Creado por Grupo ARKIK</span>
    <span><a href="legal.html">Legal</a> · <a href="garantias.html">Garantías</a> · <a href="politicas-privacidad.html">Políticas y privacidad</a> · <a href="terminos-condiciones.html">Términos y condiciones</a></span>
  </div>
</footer>

<a class="wa-float" href="https://api.whatsapp.com/send?phone=526561095490" target="_blank" rel="noopener" aria-label="Escríbenos por WhatsApp"><img src="images/icon-whatsapp.png" alt="WhatsApp"></a>
...
<section class="hero" id="inicio">
  <video class="hero-video" data-bg autoplay muted loop playsinline poster="images/hero-poster.jpg">
    <source src="videos/hero.mp4" type="video/mp4">
  </video>
  <div class="hero-inner">
    <h1>De la visión a la realidad</h1>
    <div class="tagline-pill">Construimos Contigo</div>
    <div>
      <a class="btn-pill" href="https://api.whatsapp.com/send?phone=526561095490" target="_blank" rel="noopener">Pide tu presupuesto ›</a>
    </div>
  </div>
</section>
...
<section class="portfolio-fan-wrap" id="remodelacion">
  <div class="wrap">
    <div class="portfolio-fan" data-images='["images/construccion-residencial.jpg","images/remodelacion-cocinas.jpg","images/construccion-comercial.jpg","images/remodelacion-banos.jpg","images/3d-plaza-caporal.jpg","images/construccion-corporativa.jpg","images/remodelacion-fachadas.jpg","images/3d-casa-pao.jpg"]'></div>
    <a class="fan-badge" href="https://www.grupoarkik.com/_files/ugd/6ab1eb_3b5ccdfc936b4402ac11c60393402bea.pdf" target="_blank" rel="noopener">Portafolio</a>
  </div>
</section>
...
<section class="form-section" id="contacto">
  <div class="wrap form-layout reveal">
    ...
    <form id="quoteForm">
      ...
      <p class="form-note" id="formNote">Se abrió tu app de correo con los datos listos para enviar — solo confirma el envío ahí.</p>
    </form>
  </div>
</section>
'''
